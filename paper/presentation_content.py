...
SLIDES = [
    ...
    # --------------------------------------------------------------- 17
    {
        ...
        "items": [
            ...
            ("Fleet governance scales to ~50 tenants",
             "v2.4.0 added a Multi-Tenant Fleet Governance chapter (Operations) with four moves: constraint inheritance, cross-tenant isolation, partitioned telemetry, platform-tier failure-locus. At hundreds of tenants, additional org machinery is needed."),
