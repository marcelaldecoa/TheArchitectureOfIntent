...
4. **Execute against the spec** and categorize the first three failures using the [seven failure categories](../foundations/05-failure-as-design-signal.md). How many are spec gaps versus model-level limitations?
