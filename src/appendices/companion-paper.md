...
| **§3.1 Intent as a design surface** | The intent / implementation / requirements / policy distinctions | [Intent vs. Implementation](../foundations/02-intent-vs-implementation.md) |
...
| **§3.3 Four dimensions of calibration** | Agency, autonomy, responsibility, reversibility; the orthogonality argument (Figure 3); spec-clause mapping | [Calibrate Agency, Autonomy, Responsibility, Reversibility](../foundations/03-agency-autonomy-responsibility.md); [Four Dimensions of Governance](../frame/03-archetype-dimensions.md) |
