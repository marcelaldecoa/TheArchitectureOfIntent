...
| Title | Key question |
|-------|-------------|
| [Pick an Archetype](../frame/02-canonical-intent-archetypes.md) | What kind of system is this — Advisor, Executor, Guardian, Synthesizer, or Orchestrator? |
| [The Advisor](../frame/archetypes/advisor.md) | Information-surfacing archetype: full specification |
| [The Executor](../frame/archetypes/executor.md) | Bounded-action archetype: full specification |
...
| Title | Key question |
|-------|-------------|
| [Spec-Driven Development](../specify/01-what-sdd-means.md) | What is SDD and how is it different from requirements writing? |
| [The Spec as Control Surface](../specify/02-specs-as-control-surfaces.md) | How does a spec actually control what an agent does? |
| [The Spec Lifecycle](../specify/03-spec-lifecycle.md) | What phases does a spec move through from intent to validation? |
| [Writing for Machine Execution](../specify/05-writing-specs-for-agents.md) | What makes an agent-executable spec different from a human-readable one? |
| [The Living Spec](../specify/06-living-specs.md) | How do specs evolve after execution and capture learning? |
| [The Canonical Spec Template](../specify/07-canonical-spec-template.md) | What does a complete spec look like? |
| [Architectural Decision Records](../specify/08-architectural-decision-records.md) | How do ADRs and specs relate; when to write each; the canonical ADR format with Spec Mapping section |
| [SpecKit](../specify/04-speckit.md) | How does the SpecKit toolchain support spec-driven development? |
...
| Title | Key question |
|-------|-------------|
| [What Agents Are](../delegate/01-what-agents-are.md) | What precisely is an agent, and what are its operational limits? |
| [Autonomy Without Agency](../delegate/02-autonomy-vs-agency.md) | Why does the autonomy/agency distinction matter in practice? |
| [The Executor Model](../delegate/03-agents-as-executors.md) | How do agents relate to the intent encoded in specs? |
| [Least Capability](../delegate/04-tools-mcp-capability-boundaries.md) | How do tool manifests and MCP define what an agent can reach? |
| [Portable Domain Knowledge](../delegate/05-agent-skills.md) | What are SKILL.md files and how do they carry domain context? |
| [Coding Agents](../delegate/08-coding-agents.md) | How do the framework's archetypes, spec, and oversight apply to the most-deployed agent class (Cursor, Cline, Devin, Claude Code)? |
| [Computer-Use Agents](../delegate/09-computer-use-agents.md) | How do the framework's disciplines apply to GUI-acting agents (Claude Computer Use, OpenAI Operator, Gemini computer use); the new Cat 7 Perceptual Failure category |
...
| Title | Purpose |
|-------|---------|
| [The Model Context Protocol](../delegate/mcp/01-what-is-mcp.md) | Protocol overview |
| [Designing MCP Tools](../delegate/mcp/02-designing-mcp-tools.md) | Designing tools that enforce intent rather than expose raw capability |
| [MCP Safety](../delegate/mcp/03-mcp-safety.md) | Safety considerations for MCP tool design |
...
| Title | Purpose |
|-------|---------|
| [Proportional Oversight](../delegate/06-human-oversight-models.md) | The four oversight models (Monitoring / Periodic / Output Gate / Pre-authorized) |
...
- [Orchestrator Archetype](../frame/archetypes/orchestrator.md)
...
- [Multi-Agent Governance](../frame/07-multi-agent-governance.md) (if going Devin-style)
...
- [Signs Your Architecture of Intent Is Degrading](../evolve/15-anti-patterns.md) — the 12-anti-pattern catalog and the quarterly discipline-health audit
- [The Living Spec](../specify/06-living-specs.md) — is the spec evolution log accumulating entries?
- [Four Signal Metrics](../validate/06-metrics.md) — is anyone actually looking at the metrics?
...
- [Red-Team Protocol — Computer-use-specific test patterns](../validate/08-red-team-protocol.md)
- [Multi-Agent Governance — A2A protocols](../frame/07-multi-agent-governance.md)
...
|---|---|---|---|---|
| **Conversational support agent** | [The Five Archetypes](../frame/02-canonical-intent-archetypes.md) (Advisor or Executor depending on action authority) | [Designing an AI Customer Support System](../examples/01-ai-customer-support/README.md) | Cat 1–6 (general taxonomy) | OWASP LLM01, LLM07, LLM02 (system-prompt extraction, sensitive-data disclosure) |
| **Code generation pipeline** | [Multi-Agent Governance](../frame/07-multi-agent-governance.md) (Synthesizer + Executor + Guardian composition) | [A Code Generation Pipeline](../examples/02-code-generation-pipeline/README.md) | Cat 5 (compounding) particularly relevant | OWASP LLM05 (improper output handling) |
| **Coding agent (in-loop)** | [Coding Agents](../delegate/08-coding-agents.md) (Executor with Synthesizer composition; can escalate to Orchestrator-over-self) | [Designing an AI Coding Agent](../examples/03-coding-agent/README.md) | Test deletion (Cat 1+3), dependency typosquat (Cat 2), hallucinated APIs (Cat 6), scope-creep refactors (Cat 3) | Supply-chain (LLM03), excessive agency (LLM06), coding-agent-specific patterns in [Red-Team Protocol](../validate/08-red-team-protocol.md) |
| **Computer-use / browser-use agent** | [Computer-Use Agents](../delegate/09-computer-use-agents.md) (deployment-posture-dependent: Advisor / Executor / Orchestrator-over-self) | (no worked example yet — under-served chapter) | Cat 1–6 plus **Cat 7 (Perceptual Failure)** with 4 sub-categories | Computer-use-specific test patterns in [Red-Team Protocol](../validate/08-red-team-protocol.md): lookalike domains, visual instruction injection, modal popup interception, etc. |
| **Multi-agent system** | [Multi-Agent Governance](../frame/07-multi-agent-governance.md) (any composition; supervisor / pipeline / peer patterns) | Both Example 1 and Example 2 | MAST 14-category empirical taxonomy applies; the book's Cat 5 (compounding) is the dominant shape | Cross-agent injection, handoff manipulation, A2A protocol-layer attacks |
