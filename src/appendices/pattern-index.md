...
| **MAST taxonomy** (Cemri et al.) | 2025 | [Failure Modes and How to Diagnose Them](../theory/05-failure-as-design-signal.md), [Multi-Agent Governance](../architecture/07-multi-agent-governance.md) | Empirical 14-category multi-agent failure partition; complementary to (not replacing) the book's six-category fix-locus taxonomy |
