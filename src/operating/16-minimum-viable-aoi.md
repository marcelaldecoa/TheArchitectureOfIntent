...
4. **A tripwire** — the escalation trigger is the equivalent of [§13 Spec Evolution Log](../sdd/07-canonical-spec-template.md) at MVP scale. It is what tells you the system has crossed into needing more than the MVP.
...
- [The Canonical Spec Template](../sdd/07-canonical-spec-template.md) — the 12-section spec the MVP omits most of
