...
- **Spec gap log** ([The Living Spec](../sdd/06-living-specs.md)) — anomalies, surfaces, and incident traces become candidate spec-gap entries.
- **Eval suite** ([Evals and Benchmarks](07-evals-and-benchmarks.md) Level 4) — production traces are the source for golden-set construction.
- **Red-team protocol** ([Red-Team Protocol](08-red-team-protocol.md)) — the alert layer is what triggers anomaly-driven investigation.
...
- [Red-Team Protocol](08-red-team-protocol.md) — anomaly investigation depends on the alert layer
- [The Living Spec](../sdd/06-living-specs.md) — the spec gap log consumes telemetry-driven anomalies as candidate entries
