...
The four-level eval stack from [Evals and Benchmarks](../operating/07-evals-and-benchmarks.md) applies. Three specifics:
...
- [Red-Team Protocol](../operating/08-red-team-protocol.md) — computer-use-specific attack patterns
- [Multi-Agent Governance](../architecture/07-multi-agent-governance.md) — when computer-use agents are part of a larger system
