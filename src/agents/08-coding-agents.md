...
The six categories from [Failure Modes and How to Diagnose Them](../theory/05-failure-as-design-signal.md) all manifest in coding agents, but several show up in characteristic shapes:
