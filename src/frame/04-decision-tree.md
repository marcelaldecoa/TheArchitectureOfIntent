...
- [The Canonical Spec Template](../specify/07-canonical-spec-template.md) — the archetype declaration section
- [SpecKit](../specify/04-speckit.md) — SpecKit's archetype integration
