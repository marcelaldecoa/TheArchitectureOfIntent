...
- [The Canonical Spec Template](../specify/07-canonical-spec-template.md) — the oversight and constraint sections
- [The Intent Archetype Catalog](../repertoires/02-archetype-catalog.md) — full dimension profiles per archetype
- [Proportional Oversight](../delegate/06-human-oversight-models.md) — implementing the four oversight models
