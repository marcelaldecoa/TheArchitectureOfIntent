...
For systems with embedded components (Patterns A–D) or mode-switching (Pattern E), §4 of the [canonical spec template](../specify/07-canonical-spec-template.md) (Archetype Declaration) is extended with a **Composition Declaration** sub-block. The fragment below is the canonical form:
...
- [The Canonical Spec Template](../specify/07-canonical-spec-template.md) — multi-component spec structure
