...
**Archetype series:** [← Synthesizer](synthesizer.md) · [Begin Part 2 (The Spec) →](../../specify/01-what-sdd-means.md)  
...
**SDD:** [The Canonical Spec Template](../../specify/07-canonical-spec-template.md)  

---

*The five archetype deep dives are complete. Continue to [Part 2 (The Spec)](../../specify/01-what-sdd-means.md).*
